...
% Divergence approximate Ritz solutions with symbolic computation
...
fprintf('First divergence speed is: %f m/s\n',Ud_ms);
fprintf('First divergence dynamic pressure is: %f Pa\n\n',Pd_Pa);

% write dynamic divergence pressure in output file
fileID = fopen('div_pressure_Pa.txt','w');
text_output = '%f'; 
fprintf(fileID,text_output,Pd_Pa);
fclose(fileID);